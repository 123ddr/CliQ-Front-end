...
const signUpSchema = yup.object({
  ...
  email: yup.string().email("Should be valid").required("Email address is required"),
          ...
          <div className="col-12">
            <div className="auth-card">
              ...
              <form action="" onSubmit={formik.handleSubmit} className="d-flex flex-column gap-15">
                ...
                <CustomInput type="text" name="lastname" placeholder="Last Name"  value={formik.values.lasttname} onChange={formik.handleChange("lastname")} onBlur={formik.handleBlur("lastname")} />
                <div className="error">
